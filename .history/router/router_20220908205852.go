...
func Start() {
	...
	e.GET("/addanswer", controller.AddAnswer) // localhost:8080/addanswer?username=sxy&content=3+3&post_id=1
	e.GET("/getanswer", controller.GetAnswer) // localhost:8080/getanswer?username=sxy
	e.GET("/changeans", controller.ChangeAnswer) // localhost:8080/changeanswer?id=1&content=2+2=
