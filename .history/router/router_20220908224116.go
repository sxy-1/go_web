...
func Start() {
	...
	e.GET("/login", controller.Login)  // localhost:8080/login?username=sxy&password=123456
	...
	e.GET("/deletepost",controller.Deletepost) // localhost:8080/deletepost?id=3
	...
	e.GET("/deleteanswer",controller.Deleteanswer) // localhost:8080/deleteanswer?id=3

	e.GET("/addcomment", controller.AddComment) // localhost:8080/addcomment?username=sxy&content=good&answer_id=1
	e.GET("/getcomment", controller.GetComment) // localhost:8080/getcomment?username=sxy
	e.GET("/changecomment", controller.ChangeComment) // localhost:8080/changecomment?id=1&content=bad
